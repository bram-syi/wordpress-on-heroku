...
class Twitter_Timelines_HomeTimeline_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param bool $value (optional, boolean) An advanced option for returning more verbose metadata. When set to either true or 1, each tweet will include a node called "entities".
     * @return Twitter_Timelines_HomeTimeline_Inputs For method chaining.
     */
     ...
     *
     * @param bool $value (optional, boolean) When set to either true or 1,the timeline will contain native retweets (if they exist) in addition to the standard stream of tweets.
     * @return Twitter_Timelines_HomeTimeline_Inputs For method chaining.
     */
...
class Twitter_Search_Query_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param bool $value (optional, boolean) When set to either true or 1, each tweet will include a node called "entities". This node offers a variety of extra metadata about the tweet.
     * @return Twitter_Search_Query_Inputs For method chaining.
     */
    public function setIncludeEntities($value)
    {
...
class Twitter_Tweets_StatusesShow_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param bool $value (optional, boolean) When set to either true or 1, each tweet will include a node called "entities,". This node offers a variety of metadata about the tweet.
     * @return Twitter_Tweets_StatusesShow_Inputs For method chaining.
     */
    public function setIncludeEntities($value)
    {
