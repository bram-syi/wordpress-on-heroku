...
class FedSpending_Assistance extends Temboo_Choreography
{
     ...
     * Allows access to the information in the Federal Assisatance Award Data System (FAADS) database, which reports all financial assistance made by federal agencies.
     *
     * @param Temboo_Session $session The session that owns this Assistance choreography.
     ...
     *
     * Execution object provides access to results appropriate for this Assistance choreography.
     *
     ...
     *
     * Includes setters appropriate for this Assistance choreography.
     *
...
/**
 * Inputs object with appropriate setters for the Assistance choreography.
 *
 * @package Temboo
 * @subpackage FedSpending
 */
...
{
   /**
     * Inputs object with appopriate setters for the Assistance choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AgencyCode input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the AssistanceType input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the CFDAProgram input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the Detail input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the FederalID input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the FirstYearRange input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the FiscalYear input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the LastYearRange input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the MajAgency input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the MaxRecords input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the PrincipalPlaceCC input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the PrincipalPlaceStateCode input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the RecipientCityName input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the RecipientCountyName input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the RecipientDistrict input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the RecipientName input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the RecipientStateCode input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the RecipientType input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the RecipientZip input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the SortBy input for this Assistance choreography.
     *
    ...
    /**
     * Set the value for the TextSearch input for this Assistance choreography.
     *
...
/**
 * Execution object for the Assistance choreography.
 *
 * @package Temboo
 * @subpackage FedSpending
 */
class FedSpending_Assistance_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param FedSpending_Assistance $choreo The choregraphy object for this execution.
     * @param FedSpending_Assistance_Inputs|array $inputs (optional) Inputs as FedSpending_Assistance_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Assistance execution.
     *
...
/**
 * Results object with appopriate getters for the Assistance choreography.
 *
 * @package Temboo
 * @subpackage FedSpending
 */
...
class FedSpending_Contracts extends Temboo_Choreography
{
     ...
     * Allows access to the information in the Federal Procurement Data System (FPDS) database, which reports all federal contracts awarded. 
     *
     * @param Temboo_Session $session The session that owns this Contracts choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Contracts choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Contracts choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Contracts choreography.
 *
 * @package Temboo
 * @subpackage FedSpending
 */
...
{
   /**
     * Inputs object with appopriate setters for the Contracts choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the City input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the CompanyName input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the Completion input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the Detail input for this Contracts choreography.
     *
     * @param string $value (optional, string) Controls the level of detail of the output. Acceptable values: -1 (summary), 0 (low), 1 (medium), 2 (high), and 3 (extensive). Defaults to -1. See docs for more information.
     * @return FedSpending_Contracts_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the FirstYearRange input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the FiscalYear input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the LastYearRange input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the MajAgency input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the MaxRecords input for this Contracts choreography.
     *
     * @param int $value (optional, integer) Allows you to set the maximum number of records retrieved. Defaults to 100.
     * @return FedSpending_Contracts_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ModAgency input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the PIID input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the PSCCategory input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the PSC input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the PopCountryCode input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the PopDistrict input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the PopZipCode input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the SortBy input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the StateCode input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the State input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the TextSearch input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the VendorCountryCode input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the VendorDistrict input for this Contracts choreography.
     *
    ...
    /**
     * Set the value for the ZipCode input for this Contracts choreography.
     *
...
/**
 * Execution object for the Contracts choreography.
 *
 * @package Temboo
 * @subpackage FedSpending
 */
class FedSpending_Contracts_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param FedSpending_Contracts $choreo The choregraphy object for this execution.
     * @param FedSpending_Contracts_Inputs|array $inputs (optional) Inputs as FedSpending_Contracts_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Contracts execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return FedSpending_Contracts_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Contracts choreography.
 *
 * @package Temboo
 * @subpackage FedSpending
 */
...
class FedSpending_Recovery extends Temboo_Choreography
{
     ...
     * Allows access to the information in the Recovery Act Recipient Reports database.
     *
     * @param Temboo_Session $session The session that owns this Recovery choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Recovery choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Recovery choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Recovery choreography.
 *
 * @package Temboo
 * @subpackage FedSpending
 */
...
{
   /**
     * Inputs object with appopriate setters for the Recovery choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the Activity input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the AwardAmount input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the AwardNumber input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the AwardType input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the AwardingAgency input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the CFDA input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the Detail input for this Recovery choreography.
     *
     * @param string $value (optional, string) Controls the level of detail of the output. Acceptable values: -1 (summary), 0 (low), 1 (medium), 2 (high), and 3 (extensive). Defaults to -1. See docs for more information.
     * @return FedSpending_Recovery_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the EntityDun input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the FirstYearRange input for this Recovery choreography.
     *
     * @param int $value (conditional, integer) Specifies the first year in a range of years from 2000-2006; if used, must be used with LastYearRange and without FiscalYear.
     * @return FedSpending_Recovery_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the FiscalYear input for this Recovery choreography.
     *
     * @param int $value (conditional, integer) Specifies a single year; defaults to all years.
     * @return FedSpending_Recovery_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the FundingAgency input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the FundingTAS input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the GovtContractOffice input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the LastYearRange input for this Recovery choreography.
     *
     * @param int $value (conditional, integer) Specifies the last year in a range of years; if used, must be used with FirstYearRange and without FiscalYear.
     * @return FedSpending_Recovery_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the MaxRecords input for this Recovery choreography.
     *
     * @param int $value (optional, integer) Allows you to set the maximum number of records retrieved. Defaults to 100.
     * @return FedSpending_Recovery_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the NumberOfJobs input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the OfficerComp input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the OrderNumber input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the PopCity input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the PopCountry input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the PopDistrict input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the PopState input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the PopZip input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the ProjectDescription input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the RecipientDistrict input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the RecipientName input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the RecipientStateCode input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the RecipientType input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the RecipientZip input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the Sort input for this Recovery choreography.
     *
    ...
    /**
     * Set the value for the TextSearch input for this Recovery choreography.
     *
...
/**
 * Execution object for the Recovery choreography.
 *
 * @package Temboo
 * @subpackage FedSpending
 */
class FedSpending_Recovery_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param FedSpending_Recovery $choreo The choregraphy object for this execution.
     * @param FedSpending_Recovery_Inputs|array $inputs (optional) Inputs as FedSpending_Recovery_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Recovery execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return FedSpending_Recovery_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Recovery choreography.
 *
 * @package Temboo
 * @subpackage FedSpending
 */
