...
class Klout_User_Topics_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the APIKey input for this Topics choreography.
     *
    ...
    /**
     * Set the value for the KloutID input for this Topics choreography.
     *
...
class Klout_User_Topics_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Klout_User_Topics $choreo The choregraphy object for this execution.
     * @param Klout_User_Topics_Inputs|array $inputs (optional) Inputs as Klout_User_Topics_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
...
class Klout_Identity_ByKloutID extends Temboo_Choreography
{
     ...
     * Performs a lookup for a user's identity using a Klout ID.
     *
     * @param Temboo_Session $session The session that owns this ByKloutID choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this ByKloutID choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this ByKloutID choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the ByKloutID choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
...
{
   /**
     * Inputs object with appopriate setters for the ByKloutID choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this ByKloutID choreography.
     *
     * @param string $value (required, string) The API Key provided by Klout.
     * @return Klout_Identity_ByKloutID_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the KloutID input for this ByKloutID choreography.
     *
...
/**
 * Execution object for the ByKloutID choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
class Klout_Identity_ByKloutID_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Klout_Identity_ByKloutID $choreo The choregraphy object for this execution.
     * @param Klout_Identity_ByKloutID_Inputs|array $inputs (optional) Inputs as Klout_Identity_ByKloutID_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this ByKloutID execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Klout_Identity_ByKloutID_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the ByKloutID choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
...
class Klout_User_Score extends Temboo_Choreography
{
     ...
     * Retrieves a user's Klout Score and deltas.
     *
     * @param Temboo_Session $session The session that owns this Score choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Score choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Score choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Score choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
...
{
   /**
     * Inputs object with appopriate setters for the Score choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this Score choreography.
     *
     * @param string $value (required, string) The API Key provided by Klout.
     * @return Klout_User_Score_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the KloutID input for this Score choreography.
     *
...
/**
 * Execution object for the Score choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
class Klout_User_Score_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Klout_User_Score $choreo The choregraphy object for this execution.
     * @param Klout_User_Score_Inputs|array $inputs (optional) Inputs as Klout_User_Score_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Score execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Klout_User_Score_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Score choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
...
class Klout_Identity_ByTwitterID extends Temboo_Choreography
{
     ...
     * Performs a lookup for a user's identity using a Twitter ID.
     *
     * @param Temboo_Session $session The session that owns this ByTwitterID choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this ByTwitterID choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this ByTwitterID choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the ByTwitterID choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
...
{
   /**
     * Inputs object with appopriate setters for the ByTwitterID choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this ByTwitterID choreography.
     *
     * @param string $value (required, string) The API Key provided by Klout.
     * @return Klout_Identity_ByTwitterID_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the TwitterID input for this ByTwitterID choreography.
     *
...
/**
 * Execution object for the ByTwitterID choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
class Klout_Identity_ByTwitterID_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Klout_Identity_ByTwitterID $choreo The choregraphy object for this execution.
     * @param Klout_Identity_ByTwitterID_Inputs|array $inputs (optional) Inputs as Klout_Identity_ByTwitterID_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this ByTwitterID execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Klout_Identity_ByTwitterID_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the ByTwitterID choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
...
class Klout_Identity_ByGooglePlusID extends Temboo_Choreography
{
     ...
     * Performs a lookup for a user's identity using a Google+ ID.
     *
     * @param Temboo_Session $session The session that owns this ByGooglePlusID choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this ByGooglePlusID choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this ByGooglePlusID choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the ByGooglePlusID choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
...
{
   /**
     * Inputs object with appopriate setters for the ByGooglePlusID choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this ByGooglePlusID choreography.
     *
     * @param string $value (required, string) The API Key provided by Klout.
     * @return Klout_Identity_ByGooglePlusID_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the GooglePlusID input for this ByGooglePlusID choreography.
     *
...
/**
 * Execution object for the ByGooglePlusID choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
class Klout_Identity_ByGooglePlusID_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Klout_Identity_ByGooglePlusID $choreo The choregraphy object for this execution.
     * @param Klout_Identity_ByGooglePlusID_Inputs|array $inputs (optional) Inputs as Klout_Identity_ByGooglePlusID_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this ByGooglePlusID execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Klout_Identity_ByGooglePlusID_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the ByGooglePlusID choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
...
class Klout_Identity_ByTwitterScreenName extends Temboo_Choreography
{
     ...
     * Performs a lookup for a user's identity using a Twitter screen name.
     *
     * @param Temboo_Session $session The session that owns this ByTwitterScreenName choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this ByTwitterScreenName choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this ByTwitterScreenName choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the ByTwitterScreenName choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
...
{
   /**
     * Inputs object with appopriate setters for the ByTwitterScreenName choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this ByTwitterScreenName choreography.
     *
     * @param string $value (required, string) The API Key provided by Klout.
     * @return Klout_Identity_ByTwitterScreenName_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ScreenName input for this ByTwitterScreenName choreography.
     *
...
/**
 * Execution object for the ByTwitterScreenName choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
class Klout_Identity_ByTwitterScreenName_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Klout_Identity_ByTwitterScreenName $choreo The choregraphy object for this execution.
     * @param Klout_Identity_ByTwitterScreenName_Inputs|array $inputs (optional) Inputs as Klout_Identity_ByTwitterScreenName_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this ByTwitterScreenName execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Klout_Identity_ByTwitterScreenName_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the ByTwitterScreenName choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
...
class Klout_User_ShowUser_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the KloutID input for this ShowUser choreography.
     *
...
class Klout_User_ShowUser_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Klout_User_ShowUser $choreo The choregraphy object for this execution.
     * @param Klout_User_ShowUser_Inputs|array $inputs (optional) Inputs as Klout_User_ShowUser_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
...
class Klout_User_Influence extends Temboo_Choreography
{
     ...
     * Retrieves a user's influencers and influencees.
     *
     * @param Temboo_Session $session The session that owns this Influence choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Influence choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Influence choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Influence choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
...
{
   /**
     * Inputs object with appopriate setters for the Influence choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this Influence choreography.
     *
     * @param string $value (required, string) The API Key provided by Klout.
     * @return Klout_User_Influence_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the KloutID input for this Influence choreography.
     *
...
/**
 * Execution object for the Influence choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
class Klout_User_Influence_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Klout_User_Influence $choreo The choregraphy object for this execution.
     * @param Klout_User_Influence_Inputs|array $inputs (optional) Inputs as Klout_User_Influence_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Influence execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Klout_User_Influence_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Influence choreography.
 *
 * @package Temboo
 * @subpackage Klout
 */
