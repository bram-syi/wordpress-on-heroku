...
// ** MySQL settings ** //
define('DB_NAME', 'impactdb_dev2');    // The name of the database
define('DB_USER', 'syidb');     // Your MySQL username
define('DB_PASSWORD', 'nischal1999'); // ...and password
define('DB_HOST', 'mysql.seeyourimpact.com');    // 99% chance you won't need to change this value
