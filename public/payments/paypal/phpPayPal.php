...
class phpPayPal {
	...
	public $sandbox = CREDIT_PAYMENT_TEST;

	private $API_USERNAME = CREDIT_API_USER;
	private $API_PASSWORD = CREDIT_API_KEY;
	private $API_SIGNATURE = CREDIT_API_SIGNATURE;
	private $API_ENDPOINT = CREDIT_API_URL;
	private $PAYPAL_URL = CREDIT_VERIFY_URL;

  public function switch_payment_mode($live = false) {
    $this->sandbox = !$live;
    if (!$this->sandbox) {
	    $this->API_USERNAME = CREDIT_API_USER;
	    $this->API_PASSWORD = CREDIT_API_KEY;
	    $this->API_SIGNATURE = CREDIT_API_SIGNATURE;
	    $this->API_ENDPOINT = CREDIT_API_URL;
	    $this->PAYPAL_URL = CREDIT_VERIFY_URL;
    } else {
		  $this->API_USERNAME = CREDIT_API_USER_SB;
		  $this->API_PASSWORD = CREDIT_API_KEY_SB;
		  $this->API_SIGNATURE = CREDIT_API_SIGNATURE_SB;
		  $this->API_ENDPOINT = CREDIT_API_URL_SB;
		  $this->PAYPAL_URL = CREDIT_VERIFY_URL_SB;        
    }
  }
	...
	*/
	///
	public $payment_type = 'Sale'; // PAYMENTTYPE -- change to Authorization to not to charge
	public $email; // EMAIL
	...
	*/
    ...
    //echo '<div style="width:500px">';print_r ($nvpstr);echo '</div>'; exit();
	...
	function set_express_checkout_successful_redirect()
	{
		...
		$paypal_url = $this->PAYPAL_URL.$token.'&useraction='.$this->user_action;
