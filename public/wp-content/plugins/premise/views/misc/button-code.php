...
body .<?php echo $class; ?> {
	...
	<span class="property">-moz-box-shadow</span>: 
		<span class="s drop-shadow-x"><?php echo $button['drop-shadow-x']; ?></span>px <span class="s drop-shadow-y"><?php echo $button['drop-shadow-y']; ?></span>px <span class="s drop-shadow-size"><?php echo $button['drop-shadow-size']; ?></span>px rgba( <span class="rgb drop-shadow-color"><?php echo $this->getRgbForHex($button['drop-shadow-color']); ?></span>, <span class="a drop-shadow-opacity"><?php echo $button['drop-shadow-opacity']; ?></span>),
		inset <span class="s inset-shadow-x"><?php echo $button['inset-shadow-x']; ?></span>px <span class="s inset-shadow-y"><?php echo $button['inset-shadow-y']; ?></span>px <span class="s inset-shadow-size"><?php echo $button['inset-shadow-size']; ?></span>px rgba( <span class="rgb inset-shadow-color"><?php echo $this->getRgbForHex($button['inset-shadow-color']); ?></span>, <span class="a inset-shadow-opacity"><?php echo $button['inset-shadow-opacity']; ?></span>);
	...
	<span class="property">text-shadow</span>: 
		<span class="s text-shadow-1-x"><?php echo $button['text-shadow-1-x']; ?></span>px <span class="s text-shadow-1-y"><?php echo $button['text-shadow-1-y']; ?></span>px <span class="s text-shadow-1-size"><?php echo $button['text-shadow-1-size']; ?></span>px rgba(<span class="rgb text-shadow-1-color"><?php echo $this->getRgbForHex($button['text-shadow-1-color']); ?></span>, <span class="a text-shadow-1-opacity"><?php echo $button['text-shadow-1-opacity']; ?></span>), 
		<span class="s text-shadow-2-x"><?php echo $button['text-shadow-2-x']; ?></span>px <span class="s text-shadow-2-y"><?php echo $button['text-shadow-2-y']; ?></span>px <span class="s text-shadow-2-size"><?php echo $button['text-shadow-2-size']; ?></span>px rgba(<span class="rgb text-shadow-2-color"><?php echo $this->getRgbForHex($button['text-shadow-2-color']); ?></span>, <span class="a text-shadow-2-opacity"><?php echo $button['text-shadow-2-opacity']; ?></span>);
}
