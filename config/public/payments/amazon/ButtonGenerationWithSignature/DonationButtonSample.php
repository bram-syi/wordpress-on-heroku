...
class DonationButtonSample {
	...
	private static $accessKey = "AKIAJAAXDLHGNAAZAYNQ";				//Put your Access Key here
	private static $secretKey = "tM0/3reogQA7zCu2WrFw1DG85myMPCakKCQOLPFJ";		//Put  your Secret Key here
	...
	private static $donationType = "anyAmount"; 					//Optionally, enter the type of donation. Valid values are fixedAmount, minimumAmount and anyAmount. Default value is anyAmount
	...
	DonationButtonSample::SampleForm();
