...
class SchoolFinder_SchoolSearch extends Temboo_Choreography
{
     ...
     * Returns a list of school district profiles and related school information for a zip code, city, state, or other criteria in the search parameters.
     *
     * @param Temboo_Session $session The session that owns this SchoolSearch choreography.
     ...
     *
     * Execution object provides access to results appropriate for this SchoolSearch choreography.
     *
     ...
     *
     * Includes setters appropriate for this SchoolSearch choreography.
     *
...
/**
 * Inputs object with appropriate setters for the SchoolSearch choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
{
   /**
     * Inputs object with appopriate setters for the SchoolSearch choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this SchoolSearch choreography.
     *
    ...
    /**
     * Set the value for the City input for this SchoolSearch choreography.
     *
    ...
    /**
     * Set the value for the County input for this SchoolSearch choreography.
     *
    ...
    /**
     * Set the value for the Distance input for this SchoolSearch choreography.
     *
    ...
    /**
     * Set the value for the DistrictID input for this SchoolSearch choreography.
     *
    ...
    /**
     * Set the value for the DistrictLEA input for this SchoolSearch choreography.
     *
    ...
    /**
     * Set the value for the Latitude input for this SchoolSearch choreography.
     *
    ...
    /**
     * Set the value for the Longitude input for this SchoolSearch choreography.
     *
    ...
    /**
     * Set the value for the MinResult input for this SchoolSearch choreography.
     *
    ...
    /**
     * Set the value for the NCES input for this SchoolSearch choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this SchoolSearch choreography.
     *
    ...
    /**
     * Set the value for the SchoolID input for this SchoolSearch choreography.
     *
    ...
    /**
     * Set the value for the State input for this SchoolSearch choreography.
     *
    ...
    /**
     * Set the value for the Zip input for this SchoolSearch choreography.
     *
...
/**
 * Execution object for the SchoolSearch choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
class SchoolFinder_SchoolSearch_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param SchoolFinder_SchoolSearch $choreo The choregraphy object for this execution.
     * @param SchoolFinder_SchoolSearch_Inputs|array $inputs (optional) Inputs as SchoolFinder_SchoolSearch_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this SchoolSearch execution.
     *
...
/**
 * Results object with appopriate getters for the SchoolSearch choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
class SchoolFinder_GetStudentStats extends Temboo_Choreography
{
     ...
     * Returns student statistics for a single school, city, or state. 
     *
     * @param Temboo_Session $session The session that owns this GetStudentStats choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetStudentStats choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetStudentStats choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetStudentStats choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetStudentStats choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this GetStudentStats choreography.
     *
     * @param string $value (required, string) Your School Finder API Key.
     * @return SchoolFinder_GetStudentStats_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the City input for this GetStudentStats choreography.
     *
    ...
    /**
     * Set the value for the DistrictID input for this GetStudentStats choreography.
     *
    ...
    /**
     * Set the value for the DistrictLEA input for this GetStudentStats choreography.
     *
    ...
    /**
     * Set the value for the NCES input for this GetStudentStats choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this GetStudentStats choreography.
     *
    ...
    /**
     * Set the value for the SchoolID input for this GetStudentStats choreography.
     *
    ...
    /**
     * Set the value for the State input for this GetStudentStats choreography.
     *
    ...
    /**
     * Set the value for the Zip input for this GetStudentStats choreography.
     *
...
/**
 * Execution object for the GetStudentStats choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
class SchoolFinder_GetStudentStats_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param SchoolFinder_GetStudentStats $choreo The choregraphy object for this execution.
     * @param SchoolFinder_GetStudentStats_Inputs|array $inputs (optional) Inputs as SchoolFinder_GetStudentStats_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetStudentStats execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return SchoolFinder_GetStudentStats_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetStudentStats choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
class SchoolFinder_GBD extends Temboo_Choreography
{
     ...
     * Returns contextual and branding links to Education.com. 
     *
     * @param Temboo_Session $session The session that owns this GBD choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GBD choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GBD choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GBD choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
{
   /**
     * Inputs object with appopriate setters for the GBD choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this GBD choreography.
     *
     * @param string $value (required, string) Your School Finder API Key.
     * @return SchoolFinder_GBD_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the City input for this GBD choreography.
     *
     * @param string $value (conditional, string) The name of a city. Must also be accompanied by the corresponding state parameter.
     * @return SchoolFinder_GBD_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the DistrictID input for this GBD choreography.
     *
    ...
    /**
     * Set the value for the NCES input for this GBD choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this GBD choreography.
     *
     * @param string $value (optional, string) Format of the response returned by Education.com. Defaluts to XML. JSON is also possible.
     * @return SchoolFinder_GBD_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SchoolID input for this GBD choreography.
     *
    ...
    /**
     * Set the value for the State input for this GBD choreography.
     *
     * @param string $value (conditional, string) The two letter abbreviation of a state e.g. South Caroline should be formatted “SC”.
     * @return SchoolFinder_GBD_Inputs For method chaining.
     */
...
/**
 * Execution object for the GBD choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
class SchoolFinder_GBD_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param SchoolFinder_GBD $choreo The choregraphy object for this execution.
     * @param SchoolFinder_GBD_Inputs|array $inputs (optional) Inputs as SchoolFinder_GBD_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GBD execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return SchoolFinder_GBD_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GBD choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
class SchoolFinder_NumberOf extends Temboo_Choreography
{
     ...
     * Returns the total number of schools, the number of schools at each level (elementary, middle, high) and the number of each type of school (public, private, charter) in a given city. 
     *
     * @param Temboo_Session $session The session that owns this NumberOf choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this NumberOf choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this NumberOf choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the NumberOf choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
{
   /**
     * Inputs object with appopriate setters for the NumberOf choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this NumberOf choreography.
     *
     * @param string $value (required, string) Your School Finder API Key.
     * @return SchoolFinder_NumberOf_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the City input for this NumberOf choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this NumberOf choreography.
     *
     * @param string $value (optional, string) Format of the response returned by Education.com. Defaluts to XML. JSON is also possible.
     * @return SchoolFinder_NumberOf_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the State input for this NumberOf choreography.
     *
...
/**
 * Execution object for the NumberOf choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
class SchoolFinder_NumberOf_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param SchoolFinder_NumberOf $choreo The choregraphy object for this execution.
     * @param SchoolFinder_NumberOf_Inputs|array $inputs (optional) Inputs as SchoolFinder_NumberOf_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this NumberOf execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return SchoolFinder_NumberOf_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the NumberOf choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
class SchoolFinder_GetTestScores extends Temboo_Choreography
{
     ...
     *
     * @param Temboo_Session $session The session that owns this GetTestScores choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetTestScores choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetTestScores choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetTestScores choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetTestScores choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this GetTestScores choreography.
     *
     * @param string $value (required, string) Your School Finder API Key.
     * @return SchoolFinder_GetTestScores_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the DistrictID input for this GetTestScores choreography.
     *
     * @param string $value (conditional, string) The education.com district id.
     * @return SchoolFinder_GetTestScores_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the DistrictLEA input for this GetTestScores choreography.
     *
     * @param string $value (conditional, string) The LEA id of the district.
     * @return SchoolFinder_GetTestScores_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the NCES input for this GetTestScores choreography.
     *
     * @param string $value (conditional, string) The National Center for Education Statistics (NCES) id of the school.
     * @return SchoolFinder_GetTestScores_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ResponseFormat input for this GetTestScores choreography.
     *
     * @param string $value (optional, string) Format of the response returned by Education.com. Defaluts to XML. JSON is also possible.
     * @return SchoolFinder_GetTestScores_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SchoolID input for this GetTestScores choreography.
     *
     * @param string $value (conditional, string) The Education.com id of the school you want to find.
     * @return SchoolFinder_GetTestScores_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetTestScores choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
class SchoolFinder_GetTestScores_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param SchoolFinder_GetTestScores $choreo The choregraphy object for this execution.
     * @param SchoolFinder_GetTestScores_Inputs|array $inputs (optional) Inputs as SchoolFinder_GetTestScores_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetTestScores execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return SchoolFinder_GetTestScores_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetTestScores choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
class SchoolFinder_GetReviews extends Temboo_Choreography
{
     ...
     * Returns a list of the most recent school reviews and parent rating for a single school.
     *
     * @param Temboo_Session $session The session that owns this GetReviews choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetReviews choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetReviews choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetReviews choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetReviews choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this GetReviews choreography.
     *
     * @param string $value (required, string) Your School Finder API Key.
     * @return SchoolFinder_GetReviews_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the NCES input for this GetReviews choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this GetReviews choreography.
     *
     * @param string $value (optional, string) Format of the response returned by Education.com. Defaluts to XML. JSON is also possible.
     * @return SchoolFinder_GetReviews_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SchoolID input for this GetReviews choreography.
     *
...
/**
 * Execution object for the GetReviews choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
class SchoolFinder_GetReviews_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param SchoolFinder_GetReviews $choreo The choregraphy object for this execution.
     * @param SchoolFinder_GetReviews_Inputs|array $inputs (optional) Inputs as SchoolFinder_GetReviews_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetReviews execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return SchoolFinder_GetReviews_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetReviews choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
class SchoolFinder_DistrictSearch extends Temboo_Choreography
{
     ...
     * Returns a list of school profiles and related school information for a zip code, city, state, or other criteria in the search parameters.
     *
     * @param Temboo_Session $session The session that owns this DistrictSearch choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this DistrictSearch choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this DistrictSearch choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the DistrictSearch choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
{
   /**
     * Inputs object with appopriate setters for the DistrictSearch choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this DistrictSearch choreography.
     *
     * @param string $value (required, string) Your School Finder API Key.
     * @return SchoolFinder_DistrictSearch_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the City input for this DistrictSearch choreography.
     *
    ...
    /**
     * Set the value for the DistrictID input for this DistrictSearch choreography.
     *
     * @param string $value (conditional, string) The internal Education.com id of a school district.
     * @return SchoolFinder_DistrictSearch_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the DistrictLEA input for this DistrictSearch choreography.
     *
    ...
    /**
     * Set the value for the DistrictName input for this DistrictSearch choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this DistrictSearch choreography.
     *
     * @param string $value (optional, string) Format of the response returned by Education.com. Defaluts to XML. JSON is also possible.
     * @return SchoolFinder_DistrictSearch_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the State input for this DistrictSearch choreography.
     *
     * @param string $value (conditional, string) The two letter abbreviation of a state e.g. South Caroline should be formatted “SC”.
     * @return SchoolFinder_DistrictSearch_Inputs For method chaining.
     */
...
/**
 * Execution object for the DistrictSearch choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
class SchoolFinder_DistrictSearch_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param SchoolFinder_DistrictSearch $choreo The choregraphy object for this execution.
     * @param SchoolFinder_DistrictSearch_Inputs|array $inputs (optional) Inputs as SchoolFinder_DistrictSearch_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this DistrictSearch execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return SchoolFinder_DistrictSearch_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the DistrictSearch choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
class SchoolFinder_GetTeacherStats extends Temboo_Choreography
{
     ...
     * Returns teacher statistics for a school, district, or state. 
     *
     * @param Temboo_Session $session The session that owns this GetTeacherStats choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetTeacherStats choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetTeacherStats choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetTeacherStats choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetTeacherStats choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this GetTeacherStats choreography.
     *
     * @param string $value (required, string) Your School Finder API Key.
     * @return SchoolFinder_GetTeacherStats_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the DistrictID input for this GetTeacherStats choreography.
     *
     * @param string $value (conditional, string) The education.com district id.
     * @return SchoolFinder_GetTeacherStats_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the DistrictLEA input for this GetTeacherStats choreography.
     *
     * @param string $value (conditional, string) The LEA id of the district.
     * @return SchoolFinder_GetTeacherStats_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the NCES input for this GetTeacherStats choreography.
     *
     * @param string $value (conditional, string) The National Center for Education Statistics (NCES) id of the school.
     * @return SchoolFinder_GetTeacherStats_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ResponseFormat input for this GetTeacherStats choreography.
     *
     * @param string $value (optional, string) Format of the response returned by Education.com. Defaluts to XML. JSON is also possible.
     * @return SchoolFinder_GetTeacherStats_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SchoolID input for this GetTeacherStats choreography.
     *
     * @param string $value (conditional, string) The Education.com id of the school you want to find.
     * @return SchoolFinder_GetTeacherStats_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetTeacherStats choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
class SchoolFinder_GetTeacherStats_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param SchoolFinder_GetTeacherStats $choreo The choregraphy object for this execution.
     * @param SchoolFinder_GetTeacherStats_Inputs|array $inputs (optional) Inputs as SchoolFinder_GetTeacherStats_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetTeacherStats execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return SchoolFinder_GetTeacherStats_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetTeacherStats choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
class SchoolFinder_GetTestRating extends Temboo_Choreography
{
     ...
     * Returns the Education.com TestRating for a single school or schools within a city or zip code. 
     *
     * @param Temboo_Session $session The session that owns this GetTestRating choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetTestRating choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetTestRating choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetTestRating choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetTestRating choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this GetTestRating choreography.
     *
     * @param string $value (required, string) Your School Finder API Key.
     * @return SchoolFinder_GetTestRating_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the City input for this GetTestRating choreography.
     *
     * @param string $value (conditional, string) The name of a city. Must also be accompanied by the corresponding state parameter.
     * @return SchoolFinder_GetTestRating_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the NCES input for this GetTestRating choreography.
     *
     * @param string $value (conditional, string) The National Center for Education Statistics (NCES) id of the school.
     * @return SchoolFinder_GetTestRating_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ResponseFormat input for this GetTestRating choreography.
     *
     * @param string $value (optional, string) Format of the response returned by Education.com. Defaluts to XML. JSON is also possible.
     * @return SchoolFinder_GetTestRating_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SchoolID input for this GetTestRating choreography.
     *
     * @param string $value (conditional, string) The Education.com id of the school you want to find.
     * @return SchoolFinder_GetTestRating_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the State input for this GetTestRating choreography.
     *
     * @param string $value (conditional, string) The two letter abbreviation of a state e.g. South Caroline should be formatted “SC”.
     * @return SchoolFinder_GetTestRating_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Zip input for this GetTestRating choreography.
     *
     * @param int $value (conditional, integer) A five digit US postal code.
     * @return SchoolFinder_GetTestRating_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetTestRating choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
class SchoolFinder_GetTestRating_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param SchoolFinder_GetTestRating $choreo The choregraphy object for this execution.
     * @param SchoolFinder_GetTestRating_Inputs|array $inputs (optional) Inputs as SchoolFinder_GetTestRating_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetTestRating execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return SchoolFinder_GetTestRating_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetTestRating choreography.
 *
 * @package Temboo
 * @subpackage SchoolFinder
 */
